    ...
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                ...
                <!-- Assuming $department is passed as an object or array -->
                <h4 class="text-primary"><?= esc($department['name']) ?></h4>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="<?= base_url('dashboard') ?>">Dashboard</a></li>
                    <!-- Link updated to the singular route 'department' -->
        ...
        <div class="row">
            <div class="col-md-8 offset-md-2">
                <div class="card card-outline card-info shadow-lg">
                    ...
                    <!-- Form action updated to the singular route 'department/update/{id}' -->
                    <?= form_open(base_url('department/update/' . $department['id'])) ?>
                        <?= csrf_field() ?>
                        <!-- Hidden input to simulate a PUT request for RESTful routing -->
                        ...
                        <div class="card-footer d-flex justify-content-between">
                            <!-- Cancel link updated to the singular route 'department' -->
                            <a href="<?= base_url('department') ?>" class="btn btn-default"><i class="fas fa-times-circle mr-1"></i> Cancel</a>
