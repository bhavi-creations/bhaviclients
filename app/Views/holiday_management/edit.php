    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card card-primary">
                <?= form_open('holidays/update/' . $holiday['id']) ?>
                <div class="card-body">
                    
                    <div class="form-group">
                        <label>Holiday Name <span class="text-danger">*</span></label>
                        <input type="text" name="holiday_name" class="form-control" required value="<?= old('holiday_name', $holiday['holiday_name']) ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="holiday_date" class="form-control" required value="<?= old('holiday_date', $holiday['holiday_date']) ?>">
                    ...
                    <div class="form-group form-check">
                        <input type="checkbox" name="is_recurring" value="1" class="form-check-input" id="recurringCheck" <?= old('is_recurring', $holiday['is_recurring']) ? 'checked' : '' ?>>
                        <label class="form-check-label" for="recurringCheck">Is this a recurring holiday?</label>
                    </div>

                </div>
                <div class="card-footer">
                    <button type="submit" class="btn btn-primary"><i class="fas fa-save"></i> Update Holiday</button>
